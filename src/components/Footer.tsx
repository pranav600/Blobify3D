...
export default function Footer() {
  return (
    <footer className="w-full max-w-[95%] mx-auto mt-10 md:mt-16 mb-10 md:mb-8 relative z-50 bg-gray-100 rounded-[32px] px-6 py-8 md:px-8 md:py-10 flex flex-col md:flex-row items-center justify-between shadow-sm border border-gray-200">
